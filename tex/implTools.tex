...
\subsection{web.py}
\verb%web.py% \citep{webpy} is a lightweight python web development framework.
Being the only web framework advertised to be lightweight it had a distinct advantage over similar frameworks such as Django \citep{django} which was deemed too heavyweight to be useful to \emph{rmt}.
